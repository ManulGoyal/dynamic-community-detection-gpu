...
cpulouvain : $(OBJ1) $(DIRSRC)main_louvain.o
	$(EXEC) $(NVCC) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -o $@ $+ $(LIBRARIES)
...
$(GPUDIRSRC)modularity.o: $(GPUDIRSRC)modularity_optimisation.cu $(GPUDIRSRC)utils.o
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(GPUDIRSRC)modularity_mem.o: $(GPUDIRSRC)modularity_optimisation_mem.cu $(GPUDIRSRC)utils.o
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(GPUDIRSRC)aggregation.o: $(GPUDIRSRC)community_aggregation.cu $(GPUDIRSRC)utils.o
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(GPUDIRSRC)aggregation_mem.o: $(GPUDIRSRC)community_aggregation_mem.cu $(GPUDIRSRC)utils.o
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

$(GPUDIRSRC)gpulouvain.o: $(GPUDIRSRC)gpulouvain.cu $(OBJ1)
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
